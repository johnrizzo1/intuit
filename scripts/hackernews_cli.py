...
def main():
    ...
    parser.add_argument("action", choices=["top", "new", "best", "story"], help="Action to perform")
    parser.add_argument("--limit", type=int, default=10, help="Number of stories to fetch")
