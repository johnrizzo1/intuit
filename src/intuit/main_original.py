...
def calendar_add(event: str) -> None:
...
@calendar_app.command()
def calendar_search(keyword: str) -> None:
...
@calendar_app.command()
def calendar_delete(filename: str) -> None:
...
@notes_app.command()
def notes_add(content: str) -> None:
    """Adds a new note."""
    agent = asyncio.run(create_agent())  # Create agent with default config
    notes_tool = next(
...
@notes_app.command()
def notes_search(keyword: str) -> None:
...
@reminders_app.command()
def reminders_search(keyword: str) -> None:
...
@reminders_app.command()
def reminders_delete(id: str) -> None:
